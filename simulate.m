...
classdef simulate
    methods(Static)
        ...
        function sim = lc(par,sol)            
            ...
            t0_ind = zeros(NN,1); % Index for initial wealth.
            ...
            for i = 1:NN % Person loop.
                ...
                csim(1,i) = cpol(a0_ind(i),t0_ind(i)+1,y0_ind(i)); % Consumption in period 0 given a0.
                asim(1,i) = apol(a0_ind(i),t0_ind(i)+1,y0_ind(i)); % Savings for period 1 given a0.
                ...
                for i = 1:NN % Person loop.
                    ...
                    if age <= T % Check if still alive.
                        ...
                        if age>=tr % Retired
                            ...
                            ysim(j,i) = Gmat(j)*ygrid(y0_ind(i)); % Pension in period t given age.
                        end
