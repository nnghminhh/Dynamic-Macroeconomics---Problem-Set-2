        ...
        function sim = lc(par,sol)            
            ...
            for i = 1:NN % Person loop.
                ...
                if t0_ind(i)>=tr % Retired now.
                    ...
                    ysim(1,i) = Gmat(1) * ygrid(y0_ind(i)) * Nmat(1); % Pension in period 0 given age.
                end
            ...
            usim(1,:) = model.utility(csim(1,:),nsim(1,:),par); % Utility in period 0 given a0.
            ...
            for j = 2:TT % Time loop.
                for i = 1:NN % Person loop.
                    ...
                    if age <= T % Check if still alive.
                        ...
                        usim(j,i) = model.utility(csim(j,i),nsim(j,i),par); % Utility in period t.
