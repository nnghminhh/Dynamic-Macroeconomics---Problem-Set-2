    ...
    methods(Static)
        ...
        function [] = plot_policy(par,sol,sim)
            ...
            surf(age(1:5:end),ystate,squeeze(sol.n(1,1:5:end,:))')
                ...
                zlabel({'$n_t$'},'Interpreter','latex') 
            title('Labor Policy Function, Lowest $a_t$','Interpreter','latex')
            ...
            surf(age(1:5:end),ystate,squeeze(sol.n(end,1:5:end,:))')
                ...
                ylabel({'$y_t$'},'Interpreter','latex') 
                zlabel({'$n_t$'},'Interpreter','latex') 
            title('Labor Policy Function, Highest $a_t$','Interpreter','latex')
            ...
            plot(age,lcp_n)
                xlabel({'$Age$'},'Interpreter','latex')
                ylabel({'$n^{sim}_{t}$'},'Interpreter','latex') 
            title('LCP of labor')
